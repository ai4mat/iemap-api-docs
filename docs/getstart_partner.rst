...
.. note::
  You need authentication using `this guideline`_.
  .. _this guideline: https://iemap-api.readthedocs.io/en/latest/apiuser.html#authentication
...
.. note::
  You need repeat the second command for each data file.
